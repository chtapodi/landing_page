let CONFIG = {
	...
	commands: [{
		...
		},
		{
			...
			name: 'Projects',
			key: 't',
			url: 'https://tree.taiga.io/project/chtapodi-project-orginization/kanban',
		...
		},
		{
			...
			name: 'KanBan',
			key: 'k',
			url: 'https://tree.taiga.io/project/chtapodi-school-orginization/kanban',
		...
		},
		{
			...
			name: 'Drive',
			key: '375',
			url: 'https://drive.google.com/drive/u/1/folders/1kH-BUoPcNvKpqbKVGjhaixe4n1pCZtbi',
			// search: '/find?ref_=nv_sr_fn&q={}',
			color: 'linear-gradient(135deg, #7A5F00, #E8B708)',
			// icon: 'imdb',
			quickLaunch: false,
...

		{
			...
			name: 'Gradescope',
			key: '375',
			url: 'https://www.gradescope.com/courses/101132?email_address=quinnx%40union.edu',
			// search: '/find?ref_=nv_sr_fn&q={}',
			color: 'linear-gradient(135deg, #7A5F00, #E8B708)',
			// icon: 'imdb',
			quickLaunch: false,
...

		{
			...
			name: 'Perusall',
			key: '375',
			url: 'https://app.perusall.com/courses/compiler-design/_/dashboard/assignments/aASkXG5jDNwpbLF99',
			// search: '/find?ref_=nv_sr_fn&q={}',
			color: 'linear-gradient(135deg, #7A5F00, #E8B708)',
			// icon: 'imdb',
			quickLaunch: false,
		},
		{
			...
			name: 'Lectures',
			key: '375',
			url: 'https://ny6mediashare.ensemblevideo.com/Playlist/o3MHp2j4',
			// search: '/find?ref_=nv_sr_fn&q={}',
			color: 'linear-gradient(135deg, #7A5F00, #E8B708)',
			// icon: 'imdb',
			quickLaunch: false,
